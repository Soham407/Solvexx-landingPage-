    ...
    <footer className="bg-primary text-white pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          {/* Services */}
          <div>
            <h4 className="text-lg font-bold mb-6 border-b border-accent/30 pb-2 inline-block">Services</h4>
            <ul className="space-y-4">
          ...
          <div>
            ...
            <ul className="space-y-6">
              <li className="flex items-start space-x-3">
                ...
                <div>
                  <div className="text-accent text-xs font-bold uppercase mb-1">Corporate Office</div>
              ...
              <li className="flex items-start space-x-3">
                <MapPin className="text-accent shrink-0" size={20} />
                <div>
                  <div className="text-accent text-xs font-bold uppercase mb-1">Registered Office</div>
                  <span className="text-gray-300 text-sm">
